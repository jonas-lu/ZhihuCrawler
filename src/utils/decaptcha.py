...
class DamatuApi:
    ID = '41949'
    KEY = '36c5ff015efac5ff069a42a410f7973f'
...
if __name__ == '__main__':
    ...
    dmt = DamatuApi("wonderror", "7474974")
    # 2.调用方法：
    print(dmt.getBalance())  # 查询余额
    # print(dmt.decode('show.gif', 200))  # 上传打码
    # print(dmt.decodeUrl('https://www.zhihu.com/captcha.gif?r=1460707021533&type=login', 42)) #上传打码
    print(dmt.decodeUrl('http://weibo.cn/interface/f/ttt/captcha/show.php?cpt=2_7e4a3a07121de506', 91)) #上传打码
    # print(self.reportError('894657096')) #上报错误
